...
const HeroSection = () => {
  ...
  const descriptions = [
    ...
    "Fr. Sathish Paul SDB serves the Salesian Province of Chennai, bringing a unique approach to evangelization through visual storytelling.",
    ...
    "Through digital presence and creative ministry, Fr. Sathish Paul makes timeless truths newly visible to contemporary eyes — meeting young people where they are and speaking their native visual language."
  ]
